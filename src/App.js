...
import Contact from './Views/Contact.js'; // Changed from ContactPage to Contact 
// import Footer from './Components/Footer.js'; 
...
<Route path={sitePaths.contact} element={<Contact paths={sitePaths} />} /> {/* Changed to use Contact */} 

  ...
  return (
    <div className="page-wrapper how-it-works-page">
      <Helmet>
        ...
        {/* Ensure Lottie player script is in your public/index.html IF other Lottie animations are used elsewhere. If not, it might be removable from index.html too. */}
      </Helmet>
      ...
      {/* Residential Section (Home element) */}
      ...
      {/*
        The interstitial-lottie-section that was previously here has been removed.
      */}

      {/* Commercial Section (Business element - placed under/after the Home/Residential element) */}
      ...
      <ContactSectionCTA
        ...
        text="Take the first step towards energy independence."
